...
namespace CurrencyTempConverter
{
    class Program
    {
        ...
        {
            Console.WriteLine("Welcome ! Please enter 'c' to use the currency converter or anything else to use the temp converter.");
            string answer = Console.ReadLine();

            if (answer == "c")
            {
                Console.WriteLine("You have selected the currency converter");
                Console.WriteLine("Please enter 'a'a to convert from pounds or anything else to convert from euros.");
            ...
            else
            {
                ...
                {
                    Console.WriteLine("Please enter a temp in farenheit ");
